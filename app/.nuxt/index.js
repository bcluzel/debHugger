...
import nuxt_plugin_nuxtvuexroutersync_f2f86458 from 'nuxt_plugin_nuxtvuexroutersync_f2f86458' // Source: ./nuxt-vuex-router-sync.js (mode: 'client')
...
async function createApp(ssrContext) {
  ...
  if (process.client) {
    if (typeof nuxt_plugin_nuxtvuexroutersync_f2f86458 === 'function') await nuxt_plugin_nuxtvuexroutersync_f2f86458(app.context, inject)
